...
import { getAdvanceCheckinList } from "../../Api/services";
import { useNavigate } from "react-router-dom";
import { GrView } from "react-icons/gr";
import style from "../CheckIn/checkinList.module.css";
...
const AdvanceCheckinList = () => {
  ...
  const getCheckinDetail = async () => {
    ...
    try {
      ...
      const response = await getAdvanceCheckinList(access, updatedFilters, tenant);
    ...
    bookedRooms.forEach((booking) => {
      ...
      if (!groupedData[i]) {
        groupedData[i] = {
          ...
          /**
           * Added by - Om Shrivastava on 19-10-2024
  ...
  console.log(groupedBookedRoomList, "check dataa");
  ...
  console.log(filteredData, "before date filtered");
  ...
  // console.log(filteredAndDateFilteredData, "after date filtered ");
  ...
  return (
    <div className={style.pageFrame}>
      <div className={style.header}> {/* Modification and addition by Om Shrivastava on 03-01-2025
                  Reason : Add back icon  */}
              ...
              <TableRow>
                ...
                <TableCell align="center" style={{ padding: "0px" }}>
                  ...
                  >
                    ...
                    >
                      {sortField === "idcardType" && sortOrder === "asc" ? (
                        <AiOutlineArrowUp />
                      ) : (
                        <AiOutlineArrowDown />
                      )}
                ...
                filteredAndDateFilteredData.map((group, index) => {
                  return (
                    ...
                    >
                      ...
                      >
                        {console.log(group.roomNoVarietyPrice)}
                      ...
                      Reason : Show the room price  */}
                        {/* {group.total_amount} */}
                        {console.log(group,'checkkkkk')}
                        {group.room_charges}{", "}{group.new_room_charges}
                        {/* End of modification and addition by Om Shrivastava on 19-10-2024
                      Reason : Show the room price  */}
                      </TableCell>
...
export default AdvanceCheckinList;
