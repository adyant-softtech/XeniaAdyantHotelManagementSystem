...
import expenseStyle from "./HandoverReport.module.css";
            ...
            <StyledCard style={{ backgroundColor: "#ffebee" }}>
              ...
              <CardContent>
                ...
                <Typography
                  ...
                  style={{ fontSize: "22px", fontWeight: "500" }}
                >
                  ₹{calculateTotal("General expenses")}
                </Typography>
              </CardContent>
            </StyledCard>
          </Grid>
            ...
            <StyledCard style={{ backgroundColor: "#fff9c4" }}>
              ...
              <CardContent>
                ...
                <Typography
                  ...
                  style={{ fontSize: "22px", fontWeight: "500" }}
                >
                  ₹{calculateTotal("Commission expenses")}
                </Typography>
            ...
            <StyledCard style={{ backgroundColor: "#e8f5e9" }}>
              ...
              <CardContent>
                ...
                <Typography
                  ...
                  style={{ fontSize: "22px", fontWeight: "500" }}
                >
                  ₹{calculateTotal("Salary Expenses")}
                </Typography>
              </CardContent>
            </StyledCard>
          </Grid>
            ...
            <StyledCard style={{ backgroundColor: "#f3e5f5" }}>
              ...
              <CardContent>
                ...
                >
                  ...
                  ₹{calculateTotal("Special Expenses")}
                </Typography>
              </CardContent>
            </StyledCard>
          </Grid>
            ...
            <tbody>
              {filteredExpenses.length === 0 ? (
                <tr>
                  ...
                  colSpan="12" style={{ textAlign: "center",border:"none" }}
